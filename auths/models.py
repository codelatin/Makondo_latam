...
class Auth(AbstractBaseUser, PermissionsMixin):  # Agrego PermissionsMixin
    ...
    is_admin = models.BooleanField(default=False) # siempre se deben dejar en ingles
    is_staff = models.BooleanField(default=False)
    is_active = models.BooleanField(default=True)  # Cambiar a True para permitir inicios de sesión
